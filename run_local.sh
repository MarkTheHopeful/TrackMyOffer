...
echo "Running web server at localhost:5000 with backend at localhost:8081..."
cd WebInterface && VITE_DEV_HOST=localhost VITE_DEV_PORT=5000 VITE_API_HOST=localhost VITE_API_PORT=8081 npm run dev 2> ../logs/web.err > ../logs/web.out &
